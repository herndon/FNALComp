...
void fc::GenTrackSetIO::writeEvent(const GenTrackSet& genTrackSet,
                                   std::ofstream& gentrackdata) const {
...
void fc::GenTrackSetIO::readEvent(GenTrackSet & genTrackSet,
                                  std::ifstream & gentrackdata) {
    ...
    if (eventDataObject != "GenTrackSet") {
        std::string wrongEventDataObject =
            "GenTrackSet::readEvent: attempted to read wrong data object" + eventDataObject;
    ...
    if (version != _version) {
        std::string wrongStreamerVersion =
            "GenTrackSet::readEvent: attempted to read version " + std::to_string(
