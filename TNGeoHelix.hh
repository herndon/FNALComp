...
public:
  ...
  TGeoHelix(const TGeoHelix &);
   ...
   const Double_t *GetInitPoint() const {return fPointInit;}
   const Double_t *GetInitDirection() const {return fDirInit;}
   ...
   const Double_t  GetZStep() const {return fS;}
  Int_t           GetCharge() const {return fQ;}
   ...
   const Double_t *GetField() const {return fB;}
