...
namespace fcf {
  ...
  bool goodCandidateHelix(const fc::Helix &,const fc::DetectorGeometry&,const TrackingSelector&);
  bool goodCandidateTrack(const fc::Track &,const fc::DetectorGeometry&,const TrackingSelector&);
