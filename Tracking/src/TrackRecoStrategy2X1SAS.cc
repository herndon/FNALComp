...
void fc::TrackRecoStrategy2X1SAS::recoTracks(const HitSet& recoHitSet,TrackSetContainer& trackCandidateSet) const{
...
void fc::TrackRecoStrategy2X1SAS::findTracks(const HitSet & recoHitSet,TrackSetContainer& trackCandidateSet) const{
